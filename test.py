...
async def main(ip_address, port):
    ...
    lightObject1 = Light(doip,
                  ...
                  group_address_switch=HomeRelays.OVERLOOP_BUREAU.value,  # Address used for switching the light
    ...
    lightObject2 = Light(doip,
                ...
                group_address_switch=HomeRelays.OVERLOOP_WAND.value,  # Address for switching on/off
...
ip_address = "192.168.0.39"  # You can change this to any IP address you want to use
